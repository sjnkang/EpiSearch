...
base_dir = r'C:\Research\EpiSearch\seasonal_corr'

seasons = ['spring', 'summer']
lags = [
    'nolag', 
    'search_1week_ahead', 'search_2week_ahead', 'search_3week_ahead',
    'sewage_1week_ahead', 'sewage_2week_ahead', 'sewage_3week_ahead'
]
disease = 'Influenza'
...
for season in seasons:
    for lag in lags:
        file_path = os.path.join(base_dir, season, lag, f"{disease}.xlsx")
        ...
        plt.title(f"{disease} ({season.capitalize()}, {lag}) P-value Heatmap", fontsize=14, fontweight='bold', pad=15)
        ...
        save_path = os.path.join(save_dir, f"{disease}_{season}_{lag}_pvalue_heatmap.png")
